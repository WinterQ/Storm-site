                        ...
                        <form action="<?php echo e(route('bid.update',$bid->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" value="<?php echo e($bid->bid_date); ?>" name="bid_date" class="form-control" id="bid_date" required>
                                </div>
                                <div class="form-group">
                                    <label>Статус заявки</label>
                                    <input value="<?php echo e($bid->status ? 0:1); ?>" style="width:20px" type="checkbox" name="status" <?php echo e($bid->status ? 'checked' : ''); ?> class="form-control" id="status">
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\Storm-site\resources\views/admin/bid/edit.blade.php ENDPATH**/ ?>