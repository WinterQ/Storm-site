    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                    <div class="inner">
                        <h3><?php echo e($actuators_count); ?></h3>
                        <p>Количество приводов (Actuators)</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-pie-graph"></i>
                    </div>
                    <a href="<?php echo e(route('actuator.index')); ?>" class="small-box-footer">Подробная информация <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box bg-danger">
                    ...
                    <a href="<?php echo e(route('client.index')); ?>" class="small-box-footer">Подробная информация <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
        </div>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programs\OpenServer\domains\Storm-site\resources\views/admin/home/index.blade.php ENDPATH**/ ?>