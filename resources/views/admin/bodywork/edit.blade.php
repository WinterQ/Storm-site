                        ...
                        <form action="{{route('brand.update',$brand->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input value="{{$brand->name}}" type="text" name="name" class="form-control" id="exampleInputCategory"
                                           placeholder="Введите название марки" required>
                                </div>
                                <div class="form-group">
                                    <label for="photo" class="form-label">Фото:</label>
                                    <input value="{{'/storage/img/'.$brand->photo}}" type="file" class="form-control" id="photo"
                                           name="photo">
                                </div>
                            </div>
                            <!-- /.card-body -->
